 ...
 * @since v3.3.0
 */
inline fun Sequence<Pair<String, Any?>>.toJsonObject() = toJsonObject(Json::newObject)
 ...
 * @since v3.3.0
 */
inline fun Iterable<Pair<String, Any?>>.toJsonObject() = toJsonObject(Json::newObject)
 ...
 * @since v3.3.0
 */
inline fun Map<String, Any?>.toJsonObject() = toJsonObject(Json::newObject)
 ...
 * @since v4.0.0
 */
inline operator fun ObjectNode.plus(rhs: ObjectNode) = mergeWith(rhs, Json::newObject, Json::newArray)
