...
package org.veupathdb.lib.jackson.json
 ...
 */
@JvmOverloads
inline fun Sequence<Any?>.toJsonArray(initialSize: Int = 8) = toJsonArray(initialSize, Json::newArray)
 ...
 */
@JvmOverloads
inline fun Iterable<Any?>.toJsonArray(initialSize: Int = 8) = toJsonArray(initialSize, Json::newArray)
 ...
 * @since v4.0.0
 */
inline fun Array<Any?>.toJsonArray() = toJsonArray(Json::newArray)
 ...
 * @since v4.0.0
 */
inline operator fun ArrayNode.plus(rhs: ArrayNode) = mergeWith(rhs, Json::newArray)
